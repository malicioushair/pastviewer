...
function(include_sources OUT_VAR)
    ...
    set(_PLATFORMS android mac) # @TODO: extend the list for other platforms or think on making it more general
    set(_IS_ANDROID OFF)
    set(_IS_MAC OFF)
    if(ANDROID)
        set(_IS_ANDROID ON)
    ...
    foreach(_platform IN LISTS _PLATFORMS)
        ...
        if(NOT _is_current)
            list(FILTER _sources EXCLUDE REGEX ".*/SentryIntegration/platform/${_platform_lower}/.*")
        endif()
    endforeach()
