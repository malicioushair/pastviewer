...
elseif(ANDROID)
    ...
    set_target_properties(${PROJECT_NAME} PROPERTIES
        ...
        QT_ANDROID_VERSION_CODE "${APP_MAJOR_VERSION}${APP_MINOR_VERSION}${APP_PATCH_VERSION}"
        QT_ANDROID_VERSION_NAME "${APP_MAJOR_VERSION}.${APP_MINOR_VERSION}.${APP_PATCH_VERSION}"
    )
endif()
